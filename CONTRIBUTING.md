...
1. Create or edit the Markdown page.
...
- Every folder requires a same-named overview page placed immediately before the folder in `docs.navigation.json`.
...
The Angular app is in `front/src`. Keep it backend-less and preserve static GitHub Pages compatibility. Test user-visible behavior in `front/src/app/app.spec.ts`.
